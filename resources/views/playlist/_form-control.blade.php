...
<div class="mb-5">
    ...
    <select multiple name="tags[]" id="tags" class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
        @foreach ($tags as $tag)
